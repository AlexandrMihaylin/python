...
DepotEq.show_depot()
DepotEq.move_dep('HP LJ125i', '2', 'Отдел сбыта') #проверка валидации
DepotEq.move_dep(123, 5, 'Отдел сбыта') #проверка валидации
DepotEq.move_dep('HP LJ125i', 5, 123) #проверка валидации